...
class DatabaseSeeder:
    ...
    def _populate_review_entries_table(self, review_entries):
		...
		VALUES
		(%(asin)s, %(customerId)s, %(helpful)s, %(votes)s, %(rating)s, %(date)s);
        ''', review_entries, page_size=10000)
    ...
    def populate_database(self, dataset: Dataset):
        ...
        categories = dataset.category_hierarchy.get_width_iterator()
